...
<div class="wrapper">
  ...
  <div class="page-content">
    ...
    <div class="panel">
                <div class="panel-heading">添加用户组成员 </div>
          ...
          <div class="widget">
              ...
              <form method="post" class="form-horizontal">
                <fieldset>
                  ...
                  <div class="col-md-3">
                    <label for="tooltip-enabled" class="control-label ">会员名称</label>
                    </div>
                    <div class="col-md-9">
                    <div class="form-group">
                     <select name="uid">
                       <option>请选择会员</option>
                        <?php if(is_array($lists)): $i = 0; $__LIST__ = $lists;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["id"]); ?>"><?php echo ($vo["username"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                     </select>
                    </div>
                    </div>
                  </div>
                     <input type="text" name="group_id" value="<?php echo I('get.group_id');?>">
