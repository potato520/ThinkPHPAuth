...
<div class="wrapper">
  ...
  <div class="page-content">
    ...
    <div class="panel">
                ...
                <div class="panel-body"> <a href="<?php echo U('Rule/addRule');?>" data-toggle="modal" class="btn btn-success"> 添加权限 </a> <a href="#myModal2" data-toggle="modal" class="btn btn-warning"> Confirm </a> <a href="#myModal3" data-toggle="modal" class="btn btn-danger"> Alert ! </a> 
    ...
    <div class="row">
          ...
          <div class="widget">
            ...
            <div class="widget-content">
              ...
              <h1>获取权限列表</h1>
<form method="post">
            <?php if(is_array($option)): $i = 0; $__LIST__ = $option;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><dl>
                <dt><input type="checkbox" name="rules[]" value="<?php echo ($vo["id"]); ?>"> <?php echo ($vo["title"]); ?></dt>
                </dl><?php endforeach; endif; else: echo "" ;endif; ?>
          <!-- 是哪个用户组的 -->
          <input type="text" name="id" value="<?php echo I('get.group_id');?>">
