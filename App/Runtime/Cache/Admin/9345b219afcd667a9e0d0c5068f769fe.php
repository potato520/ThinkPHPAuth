...
<div class="wrapper">
  ...
  <div class="page-content">
    ...
    <div class="panel">
                ...
                <div class="panel-body"> <a href="<?php echo U('Rule/addGroup');?>" data-toggle="modal" class="btn btn-success"> 添加用户组 </a> <a href="#myModal2" data-toggle="modal" class="btn btn-warning"> Confirm </a> <a href="#myModal3" data-toggle="modal" class="btn btn-danger"> Alert ! </a> 
            ...
            <div class="widget-content">
              <div class="body">
                ...
                <?php if(is_array($lists)): $i = 0; $__LIST__ = $lists;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                      ...
                      <td> abc </td>
                      <td class="hidden-xs">
                      <a href="<?php echo U('Rule/addGroupUser', array('group_id'=>$vo['id']));?>"><button class="btn btn-sm btn-primary">添加成员 </button></a>
                     <a href="<?php echo U('Rule/rule_group', array('group_id'=>$vo['id']));?>"><button class="btn btn-sm btn-primary">分配权限 </button></a>
