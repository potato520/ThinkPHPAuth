          ...
          <div class="widget">
              ...
              <form method="post" class="form-horizontal">
                <fieldset>
                  ...
                  <div class="col-md-3">
                    <label for="tooltip-enabled" class="control-label ">权限名称</label>
                    </div>
                    <div class="col-md-9">
                    <div class="form-group">
                      <input type="text" name="title" placeholder="Hover over me.." data-original-title="Some explanation text here" data-placement="top" class="form-control" id="tooltip-enabled">
                    </div>
                    </div>
                  </div>

                  <div class="col-md-3">
                    <label for="tooltip-enabled" class="control-label ">权限</label>
                    </div>
                    <div class="col-md-9">
                    <div class="form-group">
                      <input type="text" name="name" placeholder="Hover over me.." data-original-title="Some explanation text here" data-placement="top" class="form-control" id="tooltip-enabled">
                    </div>
                    </div>
                  </div>
